...
class HarvesterBase(SingletonPlugin):
    ...
    def _create_or_update_package(self, package_dict, harvest_object,
        ...
        '''
        print("Entra en base.py 0: -----------------------------------")
        assert package_dict_form in ('rest', 'package_show')
        print("Entra en base.py 1: -----------------------------------")        
        try:
            print("Entra en base.py 2: -----------------------------------")
            ...
            try:
                ...
                if not 'metadata_modified' in package_dict or \
                   package_dict['metadata_modified'] > existing_package_dict.get('metadata_modified'):
                    ...
                    print("package_dict base-py %s" % package_dict)
                    print("context base.py %s" % context)
